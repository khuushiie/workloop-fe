...
import { useGetApprovalGroupsQuery } from "../../../../store/apis/dynamicWorkflow.api";
...
export function CreateWorkflowDialog({
    ...
    const handleSave = (e: React.FormEvent) => {
        ...
        onSave({ permissionCode: module, name, description, levels, canAdminApprove, isActive: status !== "false" });
    };
            ...
            footer={
                <ModalFooter>
                    ...
                    <ModalButton
                        ...
                        type="submit"
                        form={formId}
                        disabled={!module || !name || isCreating}
                    >
                        Save Workflow
                    </ModalButton>
                </ModalFooter>
                        ...
                        >
                            ...
                            <div className="max-w-sm">
                                <Select
                                    ...
                                    searchable
                                // If your custom Select component accepts a loading state:
                                // loading={isLoadingGroups} 
                                />
                            </div>
